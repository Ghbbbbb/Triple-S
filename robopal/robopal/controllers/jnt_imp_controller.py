...
class JointImpedanceController(BaseController):
    ...
    def compute_jnt_torque(
        ...
        # q_des = np.concatenate([q_des, q_cur[-4:]])
        # print("Shape of q_des:", np.shape(q_des),q_des)
        # print("Shape of q_cur:", np.shape(q_cur),q_cur)
        # print("Shape of self_k:", np.shape(self.K),self.K)
        # print("Shape of self_b:", np.shape(self.B),self.B)
        # print("Shape of v_des:", np.shape(v_des),v_des)
        # print("Shape of v_cur:", np.shape(v_cur),v_cur)
